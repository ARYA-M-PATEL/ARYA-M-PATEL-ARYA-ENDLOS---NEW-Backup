    ...
    <section class="page-title" style="background-image:url(images/resource-1/contact--bg.jpg)">
    	<div class="auto-container">
            ...
            <h1>Contact <span>us</span></h1>
				<h4 class="title pt-2  text-center">Reach out to us for unparalleled service and <br> expert guidance.</h4>
			</div>
        </div>
    </section>
    <!--End Page Title-->
	...
	<section class="contact-page-section">
        ...
        <div class="map-section">
			...
			<div class="map-outer auto-container">
				<!--Map Canvas-->
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2966.428797486099!2d-88.05778112341208!3d41.9696025596794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fac33cfefffff%3A0x2d667cd36067ee69!2sJD%20Gurus!5e0!3m2!1sen!2sin!4v1705988127519!5m2!1sen!2sin" width="100%" height="550" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
					...
					<div class="info-column col-lg-7 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<ul class="list-style-five">
								<li><span class="icon fa fa-building"></span>6N381 Acacia Ln, Medinah,   <br> IL, United States, Illinois</li>
							...
							<div class="contact-form">
								<form   id="contact-form1">
									<div class="form-group">
										<input type="text" name="firstname" id="name" value="" placeholder="Full name" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="text" name="Product" id="Product" value="" placeholder="Product" required>
									</div>
									<div class="form-group">
										<input type="text" name="IndustryType" id="IndustryType" value="" placeholder="Industry Type" required>
									</div>
									<div class="form-group">
										<input type="text" name="BusinessName" id="BusinessName" value="" placeholder="Business Name" required>
									</div>
									<!-- <div class="form-group">
									...
									<div class="form-group">
										<textarea name="message" name="massage" id="massage" placeholder="write.." ></textarea>
									</div>
									<div class="form-group">
